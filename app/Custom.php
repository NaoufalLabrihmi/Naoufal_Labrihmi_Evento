...
class Custom
{
    ...
    public static function cityName($city_id)
    {
        ...
        if ($city) {
            ...
            // Handle the case where the city with the given ID doesn't exist
    ...
    public static function eventImagePath($id)
    {
        ...
        if ($image) {
            ...
            // You can return a default image path or handle it as per your requirement
            return 'Default/image_path.jpg';
        }
    }
