    ...
    <div class="ticket created-by-anniedotexe">
        <div class="left">
            ...
            <div class="ticket-info">
                ...
                <p class="location"><span>To access the event, please ensure you have your QR code available.</span>
                    <span>Check your email for your ticket, which includes the necessary QR code.</span>
                </p>
        ...
        <div class="right">
            ...
            <div class="right-info-container">
                ...
                <!-- <img class="barcode" src="data:image/png;base64,{{ $qrCode }}"> -->
            </div>
        </div>
    </div>
</body>
