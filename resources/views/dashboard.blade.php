        ...
        <div class="row justify-content-around">
            <div class="col-lg-2 col-sm-6">
                <div class="circle-tile ">
                    <a href="#">
                        <div class="circle-tile-heading bg-primary"><i class="fa fa-users fa-fw fa-3x"></i></div>
                    </a>
                    <div class="circle-tile-content bg-primary">
                        ...
                        <a class="circle-tile-footer" href="#"> Events </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-sm-6">
                <div class="circle-tile ">
                    <a href="#">
                        <div class="circle-tile-heading bg-secondary"><i class="fa fa-users fa-fw fa-3x"></i></div>
                    </a>
                    <div class="circle-tile-content bg-secondary">
                        ...
                        <a class="circle-tile-footer" href="#"> Tickets </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-sm-6">
                <div class="circle-tile ">
                    <a href="#">
                        <div class="circle-tile-heading bg-dark"><i class="fa fa-users fa-fw fa-3x"></i></div>
                    </a>
                    <div class="circle-tile-content bg-dark">
                        <div class="circle-tile-description text-faded"> Up Comming Events </div>
            ...
            <div class="col-lg-2 col-sm-6">
                <div class="circle-tile ">
                    <a href="#">
                        <div class="circle-tile-heading bg-success"><i class="fa fa-users fa-fw fa-3x"></i></div>
                    </a>
                    <div class="circle-tile-content bg-success">
                        <div class="circle-tile-description text-faded"> Completed </div>
                        <div class="circle-tile-number text-faded ">{{$completedTotalEvents}}
                        </div>
                        <a class="circle-tile-footer" href="#"> Events </a>
                    </div>
                </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p>Date: {{dateFormat($event->event_end_date)}}</p>
