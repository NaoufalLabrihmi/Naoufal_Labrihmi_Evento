...
<style>
    ...
    .card-price:before {
        ...
        border-right: 19px solid #666565;
    }
                ...
                <div class="right-side-pro-detail pb-3 pe-3 ps-3 m-0">
                    <div class="row">
                        ...
                        <div class="col-lg-12 mt-2">
                            <p class="tag-section">
                                <strong>Location : <i class="fa fa-map-marker-alt text-primary"></i> </strong>
                                {{$events->event_address}}, {{$city->name}}
                            </p>
                        </div>
                        <div class="col-lg-12">
                                    ...
                                    <form action="{{url('events/buyTicket')}}/{{$events->event_slug}}" method="get">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" max="9" min="1" class="form-control border-secondary" name="quantity" id="quantity" aria-describedby="helpId" placeholder="">
